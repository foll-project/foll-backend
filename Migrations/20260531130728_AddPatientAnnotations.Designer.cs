...
namespace foll_backend.Migrations
{
    ...
    [Migration("20260531130728_AddPatientAnnotations")]
    partial class AddPatientAnnotations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("foll_backend.Care.Domain.Model.Entities.EmergencyContact", b =>
                {
                    b.HasOne("foll_backend.Care.Domain.Model.Entities.Patient", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_emergency_contacts_patient_patient_id");
                });
            ...
            modelBuilder.Entity("foll_backend.EmergencyAnalytics.Domain.Model.Entities.EmergencyIncident", b =>
                {
                    b.HasOne("foll_backend.EmergencyAnalytics.Domain.Model.Entities.FallType", "FallType")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_emergency_incidents_fall_type_fall_type_id");
